...
public class EmployeeManager {
    ...
    public Employee overWrite(Employee asIsEmployee, Employee toBeEmployee) {
        ...
        employee.setCerti(
                toBeEmployee.getCerti() != null ? toBeEmployee.getCerti()
        ...
        if (toBeEmployee.getName() != null) {
            ...
            employee.setPhoneNumber(
                    employee.getPhoneNumber().split("-")[0]
                            + toBeEmployee.getMiddleDigitOfPhoneNumber()
                            + employee.getPhoneNumber().split("-")[2]);
            ...
            if (employees != null) {
                if (employees.size() == 0) {
                    ...
                    outputLines.add(employees.stream()
                            ...
                            .limit(5)
                            .map(employee -> command.toString() + ","
                                    + employee.toString())    // 이 부분 수정 필요
