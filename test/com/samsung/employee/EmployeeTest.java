...
class EmployeeTest {
    ...
    void consistencyValidation() {
        Employee employee = new Employee("18050301", "KYUMOK KIM", CareerLevel.CL2, "010-9777-6055",
                "19980906", Certi.PRO);
    ...
    void lineConstructorTest() {
        Employee employeeMadeByLine = new Employee(
                "ADD, , , ,11125777,TKOQKIS HC,CL1,010-6734-2289,19991001,PRO".split(","));

        Employee employeeMadeByValue = new Employee("11125777", "TKOQKIS HC",
                CareerLevel.valueOf("CL1"), "010-6734-2289", "19991001", Certi.valueOf("PRO"));
        ...
        assertEquals(employeeMadeByValue.getMiddleDigitOfPhoneNumber(),
                employeeMadeByLine.getMiddleDigitOfPhoneNumber());
        assertEquals(employeeMadeByValue.getLast4DigitOfPhoneNumber(),
                employeeMadeByLine.getLast4DigitOfPhoneNumber());
